    ...
    <div class="user-card">
        ...
        <form class="user-form">
            <div class="inp-wr">
                ...
                <input type="text" value="Johnathan Lassels" placeholder="Enter your name" name="name">
            </div>
            <div class="inp-wr">
                <div class="inp-name">
                    Company
                </div>
                <input type="text" value="Awesome company" placeholder="Enter your company name" name="company">
            </div>
            <div class="mail">
                <div class="icon">
            ...
            <div class="password">
                ...
                <a href="settings2.html">Change password</a>
            </div>
        </form>
    </div>
