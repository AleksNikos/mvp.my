...
$(".add-user-form [type=mail]").keyup(function() {
   ...
   if(reg.test($(this).val()) == false) {
      console.log('¬ведите корректный e-mail');
      return false;
   }else{
                    ...
                    <nav class="mobile-nav">
                        <ul>
                            ...
                            <li class="<?=$this->params['pageID']=="payment"?"active":""?>">
                                <a href="/user/payment">
                                    <svg width="20px" height="15px" viewBox="0 0 27 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <desc>Created with sketchtool.</desc>
                                        <defs>
                                            <linearGradient x1="0%" y1="100%" x2="100%" y2="0%" id="linearGradient-1">
                                                <stop stop-color="#6673B4" offset="0%"></stop>
