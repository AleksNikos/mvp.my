...
class Register extends \yii\db\ActiveRecord
{
    ...
    public function addParametersInModel() {
        ...
        //Добавлено после применения нового дизайна
        $this->confirm_password = $this->password; //Повтор пароля.
        $this->purpose = "Default employee";
        $this->country = "USA";
        $this->city = "New York";
        $this->user_type = "1";
        $this->position = "Default user";
        $this->REQUESTED_FREE = "0";
